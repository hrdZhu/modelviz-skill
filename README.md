...
<table width="100%">
  <tr>
    <td width="25%" align="center"><strong>🧠 智能选图</strong><br><sub>理解表达目标与数据关系</sub></td>
    <td width="25%" align="center"><strong>🧩 模板适配</strong><br><sub>保留科研布局与视觉风格</sub></td>
    <td width="25%" align="center"><strong>📦 按需依赖</strong><br><sub>仅补全当前模板所需库</sub></td>
    <td width="25%" align="center"><strong>🔍 双重质检</strong><br><sub>技术检查与视觉检查</sub></td>
  </tr>
</table>
